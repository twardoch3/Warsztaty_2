...
if __name__ == '__main__':
    p_hashed = 'hzXL6H0N099V6DBW7ebcc06e1e7b013bf3befa8032150d5ca3ed5ed2bc5fe39ceac31aa989f7008e'
    print(password_hash('pass1', '666777DEFGaa8899'))
    # print(len(p_hashed))
    print(check_password('melomelo', p_hashed))
